...
export const IUserSchema = object().shape({
    username: string().required().min(5, 'O nome de usuário deve ter no mínimo 5 caracteres.').max(20, 'O nome de usuário deve ter no máximo 20 caracteres.').typeError('O nome de usuário é obrigatório e deve ser um valor textual.'),
